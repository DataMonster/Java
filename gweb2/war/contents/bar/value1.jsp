<%@ page language="java" import="java.util.*, java.io.IOException" import = "gweb2.bean.*" pageEncoding="ISO-8859-1"%>
<%
...
<html lang="en">
  ...
  <body>
	...
	String input ="https://s3.amazonaws.com/kevin1bucket/Pyramid.txt";
	Entity et = new Entity();
	int result = 0;
	try{
	result = et.question1(input);
	} catch (IOException e) {
		e.printStackTrace();
		}
%>
